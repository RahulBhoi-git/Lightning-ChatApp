    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1' action="">
          ...
          value={name} required placeholder='Your name' className='p-2 border border-gray-500 rounded-md
          ...
          to-violet-600 text-white p-2 rounded-full text-lg cursor-pointer'>Sava</button>
        </form>
